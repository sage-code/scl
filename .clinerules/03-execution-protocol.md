...
- Curriculum quality bar: 5+ phases of sophistication (beginner → expert), mandatory SVG diagrams with captions, commented-code rule, and Prism + exotic-language CSS guidance — see `02-architecture`.
