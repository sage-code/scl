...
**File**: `/roadmap/go/index.html` (215 lines)
...
**File**: `/roadmap/go/topic.html` (235 lines)
...
Hub click: "Syntax" topic
    ↓
URL: /roadmap/go/topic.html?topic=syntax
    ↓
...
#### Master Topics List
**File**: `/roadmap/go/topics.json` (80 lines)
```json
[
  {
    "target": "overview",
...
┌─ User Journey ─────────────────────────────────────────────────────┐
│                                                                      │
│ 1. START at /roadmap/go/index.html                              │
