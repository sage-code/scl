...
- **URL Pattern**: `/roadmap/go/topic.html?topic=arrays`
...
- **Existing**: All 12 files already present in `/roadmap/go/`

### Data Flow & Navigation

```
User starts at:
  /roadmap/index.html (Super page - all 15 languages)
         ↓
  /roadmap/go/index.html (Lab Hub - 12 topics with progress)
         ↓
  Click "Arrays" topic
         ↓
  /roadmap/go/topic.html?topic=arrays
         ↓
  ...
  Click "Next: Maps" in sidebar
         ↓
  /roadmap/go/topic.html?topic=maps
```
...
2. **Open a Topic**
   ...
   - [ ] Page loads to `/roadmap/go/topic.html?topic=overview`
...
3. **Update `/roadmap/julia/index.html`**:
